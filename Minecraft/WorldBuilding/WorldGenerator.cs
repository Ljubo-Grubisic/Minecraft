    ...
    internal static class WorldGenerator
    {
        ...
        static WorldGenerator()
        {
...

            {
                ...
                (double, double) E = (0.7353218418149, 0.466384187923);
                (double, double) F = (0.829027534612, 0.6607367359467);
                (double, double) G = (0.9279390992312, 0.8655010276145);
            ...
            Temperature = new NoiseMap(Seed, 0.00098f, noiseType: FastNoiseLite.NoiseType.OpenSimplex2, fractalType: FastNoiseLite.FractalType.None);
            Humidity = new NoiseMap(Seed, 0.001f, noiseType: FastNoiseLite.NoiseType.OpenSimplex2, fractalType: FastNoiseLite.FractalType.None);
        }
